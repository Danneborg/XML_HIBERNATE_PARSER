...
@Entity
@Table(name = "FederalTaxRegistrationPayment")
public class FederalTaxRegistrationPayment extends AbstractModel {
    @Column(name = "SparkID")
    ...
    public FederalTaxRegistrationPayment() {
    }

    public FederalTaxRegistrationPayment(String sparkID, String regAuthority, String regAuthorityAddress, String regAuthorityCode, String regDate, String lastchgdatetime, String curr, String GUID) {
        SparkID = sparkID;
