...
import project.Creators.*;
import project.Tables.CommonTable;
import project.Tables.CompanyTable;
import project.Tables.ParsingXMLStatTable;
...
//        System.out.println(properties.getProperty("procedure.FederalTaxRegistrationPayment"));
    ...
    private void loadProperties() {
        try {
            FileInputStream fileInputStream = new FileInputStream("s.properties");
