...
@Entity
@Table(name = "SpecialTaxRegimes")
public class SpecialTaxRegimes extends AbstractModel {
    ...
    public SpecialTaxRegimes() {
    }

    public SpecialTaxRegimes(String sparkId, String actualDate, String lastchgdatetime, String curr, String GUID) {
